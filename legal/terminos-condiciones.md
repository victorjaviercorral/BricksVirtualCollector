...
2.2. **Licencia de uso:** Al publicar contenido con la visibilidad en "pública", nos otorgas una licencia mundial, no exclusiva, gratuita y revocable (al borrar el contenido) para alojar, mostrar y reproducir dicho contenido en la Plataforma.
2.3. Te comprometes a no subir contenido que infrinja derechos de autor de terceros o que sea ilegal.
...
## 4. Accesibilidad
Nos esforzamos por cumplir con los estándares de accesibilidad aplicables, en la medida en que la Ley 11/2023 (transposición del European Accessibility Act) nos sea exigible como plataforma digital. Trabajamos continuamente para asegurar que el sitio sea navegable de forma clara.

## 5. Limitación de Responsabilidad
5.1. El servicio se proporciona "tal cual". No garantizamos que la Plataforma esté libre de errores o interrupciones.
5.2. No somos responsables de la pérdida de datos (fotos o inventarios). Te recomendamos mantener copias de seguridad locales de tu contenido.
